...
print "Blacker Library edition. Don't use this unless you're catalogging"
print "books in accordance with the agreement between Aliza Malz and Peter H."
print ""

while 1:
  isbn = None
  while isbn == None:
    isbn = raw_input("Please enter the ISBN, or <ENTER> for none: ")
    arec = []
    if isbn == "":
      isbn = "0"
    elif isbn[-1] == "!":
  ...
  if isbn != "0" and isbn != None and len(spectre.lookup_isbn(isbn)) > 0:
    print "This book goes to Blacker, not spectre, since we have a copy"
    continue
  else:
    print "This book goes to SPECTRE. Please stick a barcode on"
